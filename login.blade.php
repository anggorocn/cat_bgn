...
<html lang="en">
  ...
  <body id="kt_body">
    ...
    <div class="container">
        ...
        <div class="copyright"> © 2023 PT. ASDP Indonesia Ferry (Persero)</div>
    ...
    <script type="text/javascript">
        function loginsso()
        {
            vurl= "http://10.1.107.155:9009/oauth2/authorize?client_id=fDVs7DcpQSfg7Rauw9XDipLbNhtbrz&redirect_uri=https://eoffice-dev.asdp.id&response_type=code&scope=openid email profile&state=123123";
            // vurl= "http://10.1.107.155:9009/login";
