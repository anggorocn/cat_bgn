...
if(!empty($user->penilaian_pegawai_id)){
$queryMenu = new AsesorBaru();
$queryMenu=$queryMenu->selectByParamsMenu($user->penilaian_ujian_id,$user->pegawai_id,$user->penilaian_pegawai_id);
$queryMenu=json_decode(json_encode($queryMenu), true);
}
// print_r($queryMenu); exit;
?>
<!DOCTYPE html>
<html lang="en">
	<!--begin::Head-->
			...
			<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
				...
				<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
					...
					<ul class="menu-nav">
						...
						<li class="menu-item menu-item-active" aria-haspopup="true">
							<a href="app/asesor/identitascat" class="menu-link">
								<span class="menu-text" style="color: black;"><i class="fas fa-edit"></i> &nbsp; Identitas</span>
							</a>
							<?php
							$idsave='';
							for($i=0;$i<count($queryMenu);$i++){
								$penggalian_kode=$queryMenu[$i]['kode'];
								$jadwal_asesor_id=$queryMenu[$i]['jadwal_asesor_id'];
								if($penggalian_kode!='CBI'){
									$idsave=$queryMenu[$i]['jadwal_asesor_id'];
								}
								if($penggalian_kode!='PT'){
							?>
								<a href="app/asesor/penilaian/<?=$jadwal_asesor_id?>" class="menu-link">
									<span class="menu-text" style="color: black;"><i class="fas fa-edit"></i> &nbsp; <?=$penggalian_kode?></span>
								</a>
								<?php 
								}
								else{?>
								<a href="app/asesor/psikotest/<?=$idsave?>" class="menu-link">
									<span class="menu-text" style="color: black;"><i class="fas fa-edit"></i> &nbsp; Potensi</span>
								</a>
								<?php }
							}?>
							<a href="app/asesor/nilaiakhir/<?=$idsave?>" class="menu-link">
								<span class="menu-text" style="color: black;"><i class="fas fa-edit"></i> &nbsp; Nilai Akhir</span>
							</a>
							<a href="app/asesor/kesimpulan/<?=$idsave?>" class="menu-link">
								<span class="menu-text" style="color: black;"><i class="fas fa-edit"></i> &nbsp; Kesimpulan</span>
							</a>
						</li>
					</ul>
					<!--end::Menu Nav-->
