...
$disabled='';
if($query->asesor_id!=$user->pegawai_id){
    $disabled='disabled';
}
?>
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Psikotest</h3>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <select class="form-control" name="reqNilai[]" <?=$disabled?>>
                                                    <option <?php if($nilai==1){echo "selected";}?> >1</option>
                                                    <option <?php if($nilai==2){echo "selected";}?> >2</option>
                                                    <option <?php if($nilai==3){echo "selected";}?> >3</option>
                                                    <option <?php if($nilai==4){echo "selected";}?> >4</option>
                                                    <option <?php if($nilai==5){echo "selected";}?> >5</option>
                                                </select>
                                            </td>
                                            <td><?=$gap?></td>
                                        </tr>
