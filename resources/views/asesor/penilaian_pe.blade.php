...
if($penggalian_kode=='PE'){
    $jawaban=json_decode(json_encode($queryPenialanPegawaiJawaban), true);
    ...
    <div class="container">
        <div class="card card-custom">
            ...
            <form class="formadd" id="ktloginform" method="POST" enctype="multipart/form-data" autocomplete="off" >
                <div class="row">
                    <div class="col-md-6">
                        <h6 style="color:black;margin: 20px;">Isian Asesor</h6>
                    ...
                    <div class="col-md-6">
                        <h6 style="color:black;margin: 20px;">Jawaban Peserta</h6>
                        <span style="color:black;margin: 20px;">
                            Nama&nbsp;:&nbsp;<?=$queryIdentitas->nama?><br>
                        </span>
                        <span style="color:black;margin: 20px;">
                            NIP&nbsp;:&nbsp;<?=$queryIdentitas->nip_baru?><br>
                        </span>
                        <div style="height:43vh; overflow: scroll;">
                            ...
                            if(!empty($jawaban)){
                              for($j=0; $j<count($jawaban);$j++){
                                ...
                                <div class="card-body" style="border: solid gray 0.5px;border-radius: 10px; margin: 15px;">
                                    <div class="card-title">
                                        <b><?=$j+1?>.<?=$jawaban[$j]['soal']?></b><br><br>
                                        <b>a.Tuliskan situasi dan tugas ketika itu secara detail dan siapa saja yang terlibat</b><br><?=$jawaban[$j]['situasi']?><br><br>
                                        <b>b.Tuliskan kendala atau kesulitan yang Anda temui</b><br><?=$jawaban[$j]['kendala']?><br><br>
                                        <b>c.Tuliskan langkah yang Anda ambil dan mengapa mengambil langkah tersebut</b><br><?=$jawaban[$j]['langkah']?><br><br>
                                        <b>d.Tuliskan hasil atau akhir dari kejadian tersebut</b><br><?=$jawaban[$j]['hasil']?>
                                    </div>
                                </div>
                            <?php
                                } 
