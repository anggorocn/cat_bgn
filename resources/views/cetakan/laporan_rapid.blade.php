...
$totalpotensi=$arrayVal['rating1']+$arrayVal['rating2']+$arrayVal['rating3']+$arrayVal['rating4']+$arrayVal['rating5']+$arrayVal['rating6']+$arrayVal['rating7']+$arrayVal['rating8'];
...
if($tipeujian==1){
    ...
    else if ($jpmkompetensi >=78 and $jpmkompetensi <90) {
    ...
    else if ($jpmkompetensi >=68 and $jpmkompetensi < 80) {
        $kompetensiCukupOptomal='x';
    }
    else{
        $kompetensiKurangOptomal='x';
...
<table style="font-size: 9pt;font-family:arial;border-collapse: collapse;word-wrap: break-word; width: 100%;margin-left: 20px;">
    <tr>
        <td style="text-align:center;border: 1px solid black;width:5%;padding: 0px 5px;">No</td>
        <td style="text-align:center;border: 1px solid black;padding: 0px 5px;">Kompetensi</td>
        <td style="text-align:center;border: 1px solid black;width:12%;padding: 0px 5px;">Standar<br>Level</td>
        <td style="text-align:center;border: 1px solid black;width:13%;padding: 0px 5px;">Capaian<br>Potensi</td>
        <td style="text-align:center;border: 1px solid black;width:10%;padding: 0px 5px;">Gap</td>
        <td style="text-align:center;border: 1px solid black;width:10%;padding: 0px 5px;">JPM</td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">1</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kemampuan Intelektual</b><br> 
            Kemampuan mental atau kognitif individu untuk memahami, memproses, dan menerapkan informasi
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating1']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating1']-3?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;" rowspan="9"></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">2</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kemampuan Berpikir Kritis dan Strategis</b><br>
            Kemampuan untuk menganalisis, mengevaluasi, dan menilai informasi dengan cara yang rasional dan objektif
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating2']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating2']-3?></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kemampuan Menyelesaikan Permasalahan (Problem Solving)</b><br>
            Kemampuan untuk menghubungkan/ menciptakan sesuatu/ide dari hal-hal yang sebelumnya tidak memiliki hubungan
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating3']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating3']-3?></td>
    </tr>
</table>
<br>
<br>
<table style="font-size: 9pt;font-family:arial;border-collapse: collapse;word-wrap: break-word; width: 100%;margin-left: 20px;">
    ...
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">4</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Motivasi dan Komitmen (Grit)</b><br>
            Kemampuan Individu untuk berkomitmen menyelesaikan sesuatu atau ketekunan dan semangat jangka panjang untuk tetap berjuang mencapai tujuan, meski menghadapi berbagai kesulitan
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating4']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating4']-3?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;" rowspan="5"></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">5</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kesadaran Diri (Self Awareness)</b><br>
            Kemampuan untuk memahami diri sendiri dengan sebaik-baiknya dengan kesadaran terhadap pikiran, evaluasi diri, dan perasaan
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating5']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating5']-3?></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">6</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kecerdasan Emosional (Emotional Quotient)</b><br>
            Kapasitas individu untuk mengenali dan mengelola perasaannya serta peka dan peduli terhadap kondisi orang lain, mudah berinteraksi dan bekerjasama dengan orang lain.
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating6']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating6']-3?></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">7</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kemampuan Belajar Cepat dan Mengembangkan Diri (Growth Mindset)</b><br>
            Pola pikir yang mendorong seseorang untuk terus belajar dan berkembang, serta menghadapi tantangan dengan positif
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating7']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating7']-3?></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;vertical-align: top;">8</td>
        <td style="padding: 0px 5px;border: 1px solid black; word-wrap: break-word;">
            <b>Kemampuan Interpersonal</b><br>
            Keterampilan komunikasi yang dimiliki oleh seseorang dalam hubungannya dengan orang lain, baik secara verbal maupun non-verbal
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">3</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating8']?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$arrayVal['rating8']-3?></td>
    </tr>
    <tr>
        <td style="padding: 0px 5px;border: 1px solid black;"></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align: center;"><b>TOTAL</b>
        </td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;">24</td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$totalpotensi?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=$totalpotensi-24?></td>
        <td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=round((($totalpotensi)/24)*100,2)?> </td>
        <!--<td style="padding: 0px 5px;border: 1px solid black;text-align:center;"><?=round($arrayVal['jpm2'],2)?></td>-->
    </tr>
</table>
...
<table style="font-size: 9pt;font-family:arial">
    <tr>
        <td style="width: 3%;"></td>
        <td><br><b>B.   Job Person Match</b></td>
    </tr>
    <tr>
        <td></td>
        <td style="padding-left: 17px;text-align: justify;">Berdasarkan hasil penilaian, total nilai capaian kompetensi adalah <?=$totalpotensi?> dari total nilai standar 24 atau setara dengan <?=round((($totalpotensi)/24)*100,2)?> Job Person Match.</td>
    </tr>
</table>
<br>
<?php
$jpm=round((($totalpotensi)/24)*100,2);
if($queryJadwal->status_jenis==1){
    ...
    if( $jpm >=90){
        ...
        $potensiCukupOptomal='x';
    }
    else{
        $potensiKurangOptomal='x';
    }
    ?>
    <br>
    <table style="font-size: 9pt;font-family:arial;border-collapse: collapse;word-wrap: break-word; width: 100%;margin-left: 40px;">
        ...
        <tr>
            <td style="text-align:center;border: 1px solid black;width:33%;padding: 0px 5px;">Optimal</td>
            <td style="text-align:center;border: 1px solid black;padding: 0px 5px;">>= 90%</td>
            <td style="text-align:center;border: 1px solid black;width:33%;padding: 0px 5px;"><?=$potensiOptomal?></td>
        </tr>
        <tr>
            <td style="text-align:center;border: 1px solid black;width:33%;padding: 0px 5px;">Cukup Optimal</td>
            <td style="text-align:center;border: 1px solid black;padding: 0px 5px;">>= 78% s/d < 90%</td>
            <td style="text-align:center;border: 1px solid black;width:33%;padding: 0px 5px;"><?=$potensiCukupOptomal?></td>
        </tr>
        <tr>
            <td style="text-align:center;border: 1px solid black;width:33%;padding: 0px 5px;">Kurang Optimal</td>
            <td style="text-align:center;border: 1px solid black;padding: 0px 5px;">< 78%</td>
            <td style="text-align:center;border: 1px solid black;width:33%;padding: 0px 5px;"><?=$potensiKurangOptomal?></td>
        </tr>
    </table>
    <?php
}
