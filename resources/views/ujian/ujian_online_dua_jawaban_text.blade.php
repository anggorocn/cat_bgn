                            ...
                            <div class="card-body" style="height: 55vh;">
                                <section class="your-class">
                                    ...
                                    for($i=0; $i<count($querySoal);$i++){
                                        if($bank_soal_id_cek!=$querySoal[$i]['bank_soal_id'])
                                        {
                                            $bank_soal_id_cek=$querySoal[$i]['bank_soal_id'];
                                            ?>
                                            <div>
                                                <div class="row">
                                                    <div style="width:3%"><h4> <?=$no+1?>. </h4></div> 
                                                    <div style="width:97%">
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <h4><?=$querySoal[$i]['pertanyaan']?></h4>
                                                            </div>
                                                            <?php 
                                                            $no++;
                                    ...
                                    <div class="row">
                                        ...
                                        for($i=0; $i<count($querySoal);$i++){
                                             if($bank_soal_id_cek!=$querySoal[$i]['bank_soal_id'])
                                            {
                                                ...
                                                ?>
                                                <div style="width:20%;" >
                                                    <button type="button" onClick='tombolsoal(<?=$no?>)' class="btn <?=$classbtn?>" id='nomor-<?=$querySoal[$i]['bank_soal_id']?>'  style="width: 92%;margin: 4%;"><h3><?=$no+1?></h3></button>
                                                </div>
                                                <?php 
                                                $no++;
                                            }
