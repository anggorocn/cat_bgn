                            ...
                            <div class="card-body" style="height: 55vh;">
                                <section class="your-class">
                                    <?php for($i=0; $i<count($querySoal);$i++){
                                        ...
                                        if($queryIdentitas->tipe_ujian_id==76 || $queryIdentitas->tipe_ujian_id==77 || $queryIdentitas->tipe_ujian_id==78 || $queryIdentitas->tipe_ujian_id==79 
                                        || $queryIdentitas->tipe_ujian_id==80 || $queryIdentitas->tipe_ujian_id==81 || $queryIdentitas->tipe_ujian_id==82 || $queryIdentitas->tipe_ujian_id==83)
                                        {
                                            $fontSize='20px';
                                        }
                                        else{
                                        ...
                                        ?>
                                        <div>
                                            <div class="row" style="height:50vh; overflow: scroll; overflow-x:hidden ;">
                                                <div style="width:5%"><h4> <?=$i+1?>. </h4></div> 
                                                <div style="width:95%">
                                                    <div class="row">
                                                        <div class="col-lg-12" style="font-size: <?=$fontSize?>;">
                                                            <?php 
                                                            if($pertanyaan==''){
                                                                echo '<br>';
                                                            } else{?>
                                                        ...
                                                        ?>
                                                            <div class="col-lg-12">
                                                                <div class="row">                                                                   
                                                                    <div style="width:5%;font-size: 20px;text-align: right;padding-right: 10px;">
                                                                        <input type="radio" <?=$checked?> id='radio-<?=$bank_soal_id?>-<?=$bank_soal_pilihan_id?>' name='radio-<?=$bank_soal_id?>'>
                                                                    </div> 
                                                                    <div style="width:90%;font-size: <?=$fontSize?>;">
                                                                        <span class='jawaban' id='jawaban-<?=$bank_soal_id?>-<?=$bank_soal_pilihan_id?>' style="height: 20vh;"><?=$jawaban?></span>
                                                                    </div> 
                                                                </div>
                                                            </div>
                                                        <?php }?>
