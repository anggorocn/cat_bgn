...
<html lang="en">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable aside-minimize" style="background-color:black">

		<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper" style="padding-left: 0px;padding-top: 50px;">
			<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
				<div id="kt_header" class="header header-fixed black" style="left: 0px;">
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
							<a href="app" class="brand-logo">
								
								<span class="nama-aplikasi"> Aplikasi Assessment Center BPS</span>
							</a>
		...
		<script type="text/javascript">
            ...
            document.addEventListener('keydown', function(event) {
                if (event.ctrlKey && (event.key === 'c' || event.key === 'v' || event.key === 'x' || event.key === 'a')) {
                    event.preventDefault();
                     Swal.fire({
                        text: 'Dilarang Mengcopy data dari web ini',
                        icon: "error",
            ...
            document.addEventListener("keyup", function(event) {
                if (event.key === "PrintScreen") {
                    ...
                    setTimeout(() => {
            document.body.style.display = "block"; // Munculkan kembali setelah 2 detik
        }, 2000);
                }
            });
        ...
        document.addEventListener("keydown", function(event) {
            if (event.ctrlKey && event.key === "p") {
                alert("Mencetak tidak diperbolehkan!");
                event.preventDefault();
            }
        });
		</script>
