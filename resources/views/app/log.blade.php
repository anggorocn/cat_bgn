<?php
$arrdata= array(
    array("label"=>"Input Data", "field"=> "input", "alias"=> "A.acara", "display"=>"",  "width"=>"80")
    ,array("label"=>"Keterangan", "field"=> "keterangan", "alias"=> "A.tanggal_tes", "display"=>"",  "width"=>"80")
    
    // untuk dua ini kunci, data akhir id, data sebelum akhir untuk order
    , array("label"=>"sorderdefault", "field"=> "log_id",  "alias"=> "A.jadwal_awal_tes_id", "display"=>"1", "width"=>"")
    , array("label"=>"fieldid", "field"=> "log_id", "alias"=> "A.jadwal_awal_tes_id", "display"=>"1", "width"=>"")
);
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label"> Log Eror</h3>
                    </div>
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            ...
            $("#reqUnitKerja,#reqJenis").change(function() {
                ...
                jsonurl= "/SettingAwal/jsonlog/<?=$reqId?>";
                datanewtable.DataTable().ajax.url(jsonurl).load();
            });

            var reqUnitKerja= $("#reqUnitKerja").val();

            var jsonurl= "/SettingAwal/jsonlog/<?=$reqId?>";
