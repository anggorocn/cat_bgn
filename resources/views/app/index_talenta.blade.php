...
<!-- 
 ...
 -->					<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
							<a href="javascript:;" class="menu-link menu-toggle">
								<span class="menu-text"><i class="fas fa-edit"></i> &nbsp; Manajemen Talenta</span>
								<i class="menu-arrow"></i>
							</a>
							<div class="menu-submenu">
								<i class="menu-arrow"></i>
								<ul class="menu-subnav">
									<li class="menu-item" aria-haspopup="true">
										<a href="{{url('app/manajemen_talenta/grafikninebox')}}" class="menu-link">
											<i class="menu-bullet menu-bullet-dot">
												<span></span>
											</i>
											<span class="menu-text">Grafik Nine Box</span>
										</a>
									</li>
									<li class="menu-item" aria-haspopup="true">
										<a href="{{url('app/manajemen_talenta/tabelninebox')}}" class="menu-link">
											<i class="menu-bullet menu-bullet-dot">
												<span></span>
											</i>
											<span class="menu-text">Tabel Nine Box</span>
										</a>
									</li>
								</ul>
							</div>
