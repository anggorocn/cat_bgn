<?php
	$arrdata= array(
		...
		, array("label"=>"Eselon", "field"=> "eselon_nama", "alias"=> "A.eselon_nama", "display"=>"",  "width"=>"10")
		, array("label"=>"Potensi", "field"=> "potensi", "display"=>"",  "width"=>"10")
		, array("label"=>"Kinerja", "field"=> "kinerja", "display"=>"",  "width"=>"10")
		, array("label"=>"Kuadran", "field"=> "kuadran", "display"=>"",  "width"=>"10")
