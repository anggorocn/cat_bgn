	...
	<div class="row">
		<div class="col-lg-6 col-xxl-3">
			<div class="area-profil">
				<div class="foto"><img src="../../assets/media/images/img-foto.jpg"></div>
				<div class="nama">Ersa Mayori Putri</div>
				<div class="nik">(NIK : 101981590) </div>
				<div class="jabatan">General Manager Surabaya</div>
			</div>
		...
		<div class="col-lg-6 col-xxl-6">
			Selamat datang Ersa Mayori Putri,
...
<!--begin::Subheader-->
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader" style="border: 2px solid blue; display: none;">
...
<!--end::Subheader-->
<!--begin::Entry-->
<div class="d-flex flex-column-fluid" style="border: 2px solid cyan; display: none !important;">
	<!--begin::Container-->
	<div class="container">
		<!--begin::Dashboard-->
		<!--begin::Row-->
