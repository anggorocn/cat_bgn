<?php
	$arrdata= array(
		array("label"=>"Nama", "field"=> "nama", "alias"=> "A.NAMA", "display"=>"",  "width"=>"")
		// buat tombol aksi
			...
			<div class="card card-custom">
				<div class="card-header">
					...
					<div class="card-toolbar">
						<a href="{{url('app/soal/soal_detil_intray')}}" class="btn btn-primary font-weight-bolder">
							Tambah
						</a>
					</div>
				</div>
						...
						$.ajax({
							...
							success : function(data) { 
								swal.fire({
									...
									document.location.href = "app/soal/index_intray";
								});
							},
							complete: function() {
								swal.hideLoading();
