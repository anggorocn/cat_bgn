<?php
	$arrdata= array(
		array("label"=>"Tahun", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"",  "width"=>"80")
		, array("label"=>"Formula", "field"=> "potensi", "alias"=> "A.NAMA", "display"=>"",  "width"=>"80")
		, array("label"=>"Keterangan", "field"=> "potensi", "alias"=> "A.JABATAN", "display"=>"",  "width"=>"10")
		...
		, array("label"=>"sorderdefault", "field"=> "PEGAWAI_ID",  "alias"=> "A.PEGAWAI_ID", "display"=>"1")
		, array("label"=>"fieldid", "field"=> "PEGAWAI_ID", "alias"=> "A.PEGAWAI_ID", "display"=>"1")
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">Pengaturan Rencana Suksesi</h3>
                    </div>
                </div>
                        	...
                        	<div class="card card-custom">
								<div class="card-header">
									<div class="card-title">
										...
										<h3 class="card-label"> Pengaturan Bobot Penilaian</h3>
									</div>
