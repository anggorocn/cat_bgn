<?php
    $arrdata= array(
        ...
        , array("label"=>"NIP", "field"=> "nip_baru", "alias"=> "A.nip_baru", "display"=>"",  "width"=>"10")
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#reqUnitKerja,#reqJenis").change(function() {
            ...
            jsonurl= "/SettingJadwal/jsonpegawai/<?=$reqId?>/<?=$reqPenggalianId?>";
    ...
    function tampil(id, nama, nip){
        ...
        var newUrl= "/SettingJadwal/jsonpegawai/<?=$reqId?>/<?=$reqPenggalianId?>/"+arrayid;
