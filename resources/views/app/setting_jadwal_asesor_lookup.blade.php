<?php
    $arrdata= array(
        ...
        , array("label"=>"sorderdefault", "field"=> "asesor_id",  "alias"=> "A.asesor_id", "display"=>"1", "width"=>"")
        , array("label"=>"fieldid", "field"=> "asesor_id", "alias"=> "A.asesor_id", "display"=>"1", "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Pilih Asesor</h3>
                </div>
                ...
                <div id="info" class="tabcontent" style="display: block;">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="card-title">
                                <h3 class="card-label">List Asesor</h3>
                            </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#reqUnitKerja,#reqJenis").change(function() {
            ...
            jsonurl= "/SettingJadwal/jsonasesor/<?=$reqId?>/"+arrayid;
            datanewtable.DataTable().ajax.url(jsonurl).load();
        });

        var reqUnitKerja= $("#reqUnitKerja").val();

        var jsonurl= "/SettingJadwal/jsonasesor/<?=$reqId?>";
    ...
    function tampil(id, nama, waktu){
        ...
        var newUrl = "/SettingJadwal/jsonasesor/<?=$reqId?>/"+arrayid; // URL JSON baru
