...
<html lang="en">
    ...
    <body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
        <div class="d-flex flex-column flex-root">
            <div class="logo-asdp-login">
                <div class="row">
                    <img src="images/logobps.png" style="margin:0px 5px">
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="area-login">
                            <div class="inner">
                                ...
                                <div class="logo">
                                    <h1 style="color: black; ">ASSESMENT</h1>
                                    <h3 style="color: blue; letter-spacing: 5px;">Application Login</h3>
                                </div>
                                <form class="form" id="kt_login_signin_form" action="app/login/action" method="post">
                                    ...
                                    <!-- <a href="app/loginSSO" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4">LOGIN SSO</a> -->
                                    <input type="hidden" name="reqMode" value="submitLogin"/>
                                   
                                </form>
                            </div>
                            <div class="copyright" style="color: white;"> © 2025 Badan Gizi Nasional </div>
                    ...
                    <div class="col-md-5 area-kanan-login" style="display: none !important;">
                        <div class="login-form text-center p-7 position-relative overflow-hidden">
                            ...
                            <div class="nama-aplikasi">
                                <h4><strong> Aplikasi Assesment</strong></h4>
                            </div>
