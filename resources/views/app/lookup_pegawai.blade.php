			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label"> List Peserta Kuadran I</h3>
					</div>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {
			...
			$("#reqUnitKerja,#reqJenis").change(function() {
				...
				jsonurl= "/Pegawai/json?reqUnitKerja="+reqUnitKerja+"&reqJenis="+reqJenis;
				datanewtable.DataTable().ajax.url(jsonurl).load();
			});

			var reqUnitKerja= $("#reqUnitKerja").val();

		    var jsonurl= "/Pegawai/json?reqUnitKerja="+reqUnitKerja;
