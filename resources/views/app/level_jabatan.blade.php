<?php
	$arrdata= array(
		...
		, array("label"=>"sorderdefault", "field"=> "eselon_id",  "alias"=> "A.PEGAWAI_ID", "display"=>"1", "width"=>"")
		, array("label"=>"fieldid", "field"=> "eselon_id", "alias"=> "A.PEGAWAI_ID", "display"=>"1", "width"=>"")
	);
?>
...
@section('content')
			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label"> Master Level Jabatan</h3>
					</div>
					<div class="card-toolbar">
						<a href="{{url('app/level_jabatan/add')}}" class="btn btn-primary font-weight-bolder">
							Tambah
						</a>
						&nbsp;
					</div>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {
		    ...
		    var jsonurl= "/level_jabatan/json";
			ajaxserverselectsingle.init(infotableid, jsonurl, arrdata);
			 ...
			 $("#triggercari").on("click", function () {
		        if(carijenis == "1")
		        {
		            ...
		            var jsonurl= "/level_jabatan/json?reqPencarian="+pencarian;
		...
		function deletedata(id) {
			...
			{
				urlAjax= "/level_jabatan/delete/"+id;
				swal.fire({
						...
						$.ajax({
							...
							success : function(data) { 
								swal.fire({
									...
									document.location.href = "app/level_jabatan/index";
								});
							},
							complete: function() {
								swal.hideLoading();
