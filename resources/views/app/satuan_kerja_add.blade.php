...
@section('content')
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        ...
                        <h3 class="card-label"> Kelola Satuan Kerja </h3>
                    </div>
                </div>
                <div class="card-body">                    
    ...
    <script type="text/javascript">
        function kembali() {
            window.location.href='app/satuan_kerja/index';
        }

        var url = "/SatuanKerja/add";
                        ...
                        success: function (response) {
                            ...
                            else
                            {
                                Swal.fire({
                                    ...
                                    document.location.href = "app/satuan_kerja/edit/"+rowid;
                                });
                            }
                        },
