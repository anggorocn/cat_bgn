<?php
    $arrdata= array(
        ...
        , array("label"=>"Jumlah Peserta", "field"=> "total", "alias"=> "A.nip_baru", "display"=>"",  "width"=>"10")
        ...
        , array("label"=>"sorderdefault", "field"=> "kelompok_id",  "alias"=> "A.kelompok_id", "display"=>"1", "width"=>"")
        , array("label"=>"fieldid", "field"=> "kelompok_id", "alias"=> "A.kelompok_id", "display"=>"1", "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Pilih Kelompok</h3>
                </div>
                ...
                <div id="info" class="tabcontent" style="display: block;">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="card-title">
                                <h3 class="card-label">List Kelompok</h3>
                            </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#reqUnitKerja,#reqJenis").change(function() {
            ...
            jsonurl= "/SettingJadwal/jsonpegawaikelompokPilih/<?=$reqId?>";
    ...
    function tampil(id, nama, nip){
        ...
        var newUrl= "/SettingJadwal/jsonpegawaikelompokPilih/<?=$reqId?>/"+arrayid;
