<?php
	$arrdata= array(
		array("label"=>"Soal", "field"=> "pertanyaan", "alias"=> "A.NAMA", "display"=>"",  "width"=>"")
		// buat tombol aksi
		, array("label"=>"Aksi", "field"=> "aksi",  "display"=>"",  "width"=>"100")
...
@section('content')
			...
			<div class="card card-custom">
				<div class="card-header">
					...
					<div class="card-toolbar">
						...
						<a href="/app/soal/addsjt/<?=$reqId?>" class="btn btn-primary font-weight-bolder" style="margin-right: 10px;">
							Tambah
						</a>
						<a href="{{url('/app/soal/index')}}" class="btn btn-warning font-weight-bolder">
							Kembali
						</a>
					</div>
				</div>
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {
		    var jsonurl= "/Soal/jsondetilsjt/<?=$reqId?>";
						...
						$.ajax({
							...
							success : function(data) { 
								swal.fire({
									...
									document.location.href = "app/soal/detilsjt/<?=$reqId?>";
								});
							},
							complete: function() {
								swal.hideLoading();
