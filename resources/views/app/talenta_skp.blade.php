<?php
	$arrdata= array(
		array("label"=>"Tahun", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
		,array("label"=>"Nilai<br>Pengukuran", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
		,array("label"=>"Rata<br>Perilaku", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
		,array("label"=>"Nilai<br>SKP", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
		,array("label"=>"Nilai<br>Kinerja", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
		,array("label"=>"Perilaku<br>Kerja", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
		,array("label"=>"Kinerja<br>Pegawai", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"")
	...
	<script type="text/javascript">
		...
		jQuery(document).ready(function() {
			...
			$("#reqUnitKerja,#reqJenis").change(function() {
				...
				jsonurl= "/ManajemenTalenta/jsontabelninebox?reqUnitKerja="+reqUnitKerja+"&reqJenis="+reqJenis;
