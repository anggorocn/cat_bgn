<?php
    $arrdata= array(
        ...
        , array("label"=>"sorderdefault", "field"=> "kegiatan_file_id",  "alias"=> "A.kegiatan_file_id", "display"=>"1", "width"=>"")
        , array("label"=>"fieldid", "field"=> "kegiatan_file_id", "alias"=> "A.kegiatan_file_id", "display"=>"1", "width"=>"")
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#reqUnitKerja,#reqJenis").change(function() {
            ...
            jsonurl= "/SettingJadwal/jsonSoal/<?=$reqTipe?>";
            datanewtable.DataTable().ajax.url(jsonurl).load();
        });

        var reqUnitKerja= $("#reqUnitKerja").val();

        var jsonurl= "/SettingJadwal/jsonSoal/<?=$reqTipe?>";
    ...
    function tampil(id, nama, waktu){
        ...
        var newUrl = "/SettingJadwal/jsonSoal/<?=$reqTipe?>/"+id; // URL JSON baru
