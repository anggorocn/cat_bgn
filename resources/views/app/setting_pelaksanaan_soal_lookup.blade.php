<?php
    $arrdata= array(
        array("label"=>"Nama", "field"=> "tipe", "alias"=> "A.tipe", "display"=>"",  "width"=>"80")
        ...
        , array("label"=>"sorderdefault", "field"=> "tipe_ujian_id",  "alias"=> "A.tipe_ujian_id", "display"=>"1", "width"=>"")
        , array("label"=>"fieldid", "field"=> "tipe_ujian_id", "alias"=> "A.tipe_ujian_id", "display"=>"1", "width"=>"")
        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Pilih Soal</h3>
                </div>
                ...
                <div id="info" class="tabcontent" style="display: block;">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="card-title">
                                <h3 class="card-label">List Soal</h3>
                            </div>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#reqUnitKerja,#reqJenis").change(function() {
            ...
            jsonurl= "/SettingPelaksanaan/jsonsoal/"+arrayid;
            datanewtable.DataTable().ajax.url(jsonurl).load();
        });

        var reqUnitKerja= $("#reqUnitKerja").val();

        var jsonurl= "/SettingPelaksanaan/jsonsoal";
    ...
    function tampil(id, nama, waktu){
        loadingActive()
        $("#reqData0").hide();
        $('#reqData').append(nama+"<br>");
        var newRow = `<tr>
            <td>`+nama+` <input type='hidden' value='`+id+`'> </td>
        ...
        var newUrl = "/SettingPelaksanaan/jsonsoal/"+arrayid; // URL JSON baru
