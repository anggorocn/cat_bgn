<?php
    ...
    if(!empty($query)){
        ...
        if($reqId==7){
            $reqBankSoalId=$query->soal_papi_id;    
        } 
        else{
                        ...
                        if($reqId==7){?> 
                            ...
                            <table id="customers">
                                ...
                                for($i=0; $i<count($queryJawaban);$i++){?>                                
                                    <tr>
                                        <td>
                                            <input type="hidden" name="reqJawabanId[]" value="<?=$queryJawaban[$i]['papi_pilihan_id']?>">
                                            <textarea class="form-control" name="reqJawaban[]" ><?=$queryJawaban[$i]['jawaban']?></textarea>
                                        </td>
                                        <td><input class="form-control" type="text" value="<?=$queryJawaban[$i]['grade_a']?>"></td>
                                        <td><input class="form-control" type="text" value="<?=$queryJawaban[$i]['grade_b']?>"></td>
                                    </tr>
                                <?php }?>    
                            </table>
                        <?php }
                            ...
                            <table id="customers">
                                ...
                                for($i=0; $i<count($queryJawaban);$i++){?>                                
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="text" name="" value="<?=$queryJawaban[$i]['grade_prosentase']?>">
                                        </td>
                                    </tr>
                                <?php }?>    
                            </table>
