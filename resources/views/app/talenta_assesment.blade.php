<?php
	$arrdata= array(
		array("label"=>"Tanggal", "field"=> "potensi", "alias"=> "A.NIP", "display"=>"",  "width"=>"10")
		, array("label"=>"Nama Acara", "field"=> "potensi", "alias"=> "A.NAMA", "display"=>"",  "width"=>"10")
		, array("label"=>"Kompetensi", "field"=> "potensi", "alias"=> "A.JABATAN", "display"=>"",  "width"=>"10")
		, array("label"=>"Potensi", "field"=> "potensi", "alias"=> "A.eselon_nama", "display"=>"",  "width"=>"10")
                        	...
                        	<div class="card card-custom">
								<div class="card-header">
									<div class="card-title">
										...
										<h3 class="card-label"> Riwayat Assesment</h3>
									</div>
				<!-- 					<div class="card-toolbar">
									...
									<table class="table table-separate table-head-custom table-checkable" id="kt_datatable" style="margin-top: 13px !important;width:100%">
										<thead>
											<tr>
												...
												{
													echo "<th style='width:20px'>".$valitem["label"]."</th>";
												}
												?>
											</tr>
										</thead>
