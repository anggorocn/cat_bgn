<?php
	$arrdata= array(
		array("label"=>"Nama", "field"=> "potensi")
		, array("label"=>"Jabatan", "field"=> "potensi")
		, array("label"=>"Rumpun", "field"=> "potensi")
		, array("label"=>"Satuan<br>Kerja", "field"=> "potensi")
		, array("label"=>"Target", "field"=> "potensi")
                        	...
                        	<div class="card card-custom">
								<div class="card-header">
									<div class="card-title">
										...
										<h3 class="card-label"> Pengaturan Jabatan Target</h3>
									</div>
									...
									<table class="table table-separate table-head-custom table-checkable" id="kt_datatable" style="margin-top: 13px !important;width:100%">
										<thead>
											<tr>
												...
												{
													echo "<th style='width:20px !important'>".$valitem["label"]."</th>";
												}
												?>
											</tr>
										</thead>
