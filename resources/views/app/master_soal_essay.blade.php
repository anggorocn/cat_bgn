<?php
	$arrdata= array(
		array("label"=>"Penggalian", "field"=> "nama", "alias"=> "A.NIP", "display"=>"",  "width"=>"80")
		
		// buat tombol aksi
		, array("label"=>"Aksi", "field"=> "aksi",  "display"=>"",  "width"=>"10")
		
		// untuk dua ini kunci, data akhir id, data sebelum akhir untuk order
		, array("label"=>"sorderdefault", "field"=> "KODE",  "alias"=> "A.PEGAWAI_ID", "display"=>"1", "width"=>"")
		, array("label"=>"fieldid", "field"=> "KODE", "alias"=> "A.PEGAWAI_ID", "display"=>"1", "width"=>"")
	);
?>
			...
			<div class="card card-custom">
				<div class="card-header">
					<div class="card-title">
						...
						<h3 class="card-label"> Penggalian</h3>
					</div>
