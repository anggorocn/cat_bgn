<?php
    $arrdata= array(
        array("label"=>"Nama", "field"=> "pegawai_nama", "alias"=> "pegawai_nama", "display"=>"",  "width"=>"80")
        ,array("label"=>"NIP", "field"=> "pegawai_nip", "alias"=> "pegawai_nip", "display"=>"",  "width"=>"80")
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $("#reqUnitKerja,#reqJenis").change(function() {
            ...
            jsonurl= "/SettingAwal/jsonsimulasi/<?=$reqId?>/"+arrayid;
            datanewtable.DataTable().ajax.url(jsonurl).load();
        });

        var reqUnitKerja= $("#reqUnitKerja").val();

        var jsonurl= "/SettingAwal/jsonsimulasi/<?=$reqId?>";
    ...
    function tampil(id, nama, nip){
        ...
        var newUrl = "/SettingAwal/jsonsimulasi/<?=$reqId?>/"+arrayid; // URL JSON baru
